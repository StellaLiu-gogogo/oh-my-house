...
- **日期：** 2026-08-27
- **阶段：** Product Design
- **状态：** 核心产品结构和主要流程已经形成；尚未开始技术设计或写代码
- **目的：** 区分已确认、现在仍需确认、可以以后决定的内容
...
现在仍不适合直接写代码，因为多设备同步的具体体验和通知发送对象还有少量重要问题需要确认；
技术方案也尚未选择。
...
这些问题会影响后续技术设计，建议在选择技术方案前确认。

### 3.1 同步的具体行为

当前 Agent 推荐：

所有家庭共享数据参与同步已经确认。仍需确认：
...
1. 确认同步剩余的 5 项具体行为；
2. 确认不同类型提醒发送给谁；
3. 做一次正式的 Product Design v0.1 sign-off；
4. 然后再进入技术架构比较，不直接开始写代码。
